...
A [W3C criou uma forma de calcular a especificidade de seletores](http://www.w3.org/TR/css3-selectors/#specificity). Para entender de forma simples, basicamente distribuímos pesos diferentes as regras aplicadas:
...
<blockquote class="twitter-tweet" lang="pt"><p lang="en" dir="ltr">Easy way to tell how screwed you are when dealing with CSS from a legacy project:&#10;&#10;`grep -rin &#39;!important&#39; assets/sass/ | wc -l`</p>&mdash; Rafael Rinaldi (@rafaelrinaldi) <a href="https://twitter.com/rafaelrinaldi/status/586216597913739264">9 abril 2015</a></blockquote>
...
Caso queira saber mais sobre efeito cascata e herança, [recomendo esse post do Tableless de 2009](http://tableless.com.br/efeito-cascata-e-especificidade-do-css/).

## A herança

A palavra herança rapidamente remete ao paradigma de [Orientação a Objetos](https://pt.wikipedia.org/wiki/Orienta%C3%A7%C3%A3o_a_objetos). Caso você acompanhe discussões sobre _front-end_, já deve saber que o termo “_orientação a objetos_” não é bem visto tratando-se de CSS.
...
Se você é purista e não gosta de pré-processadores ou prefere não usar as “mágicas” do Sass, você pode fazer uso da concatenação/composição de classes no HTML. O [Bootstrap](http://getbootstrap.com/) usa essa abordagem.
...
Herança é uma abordagem extremamente necessária para começar a entender o desenvolvimento de CSS escalável. Depois de entender bem o conceito, estude [padrões de escrita](http://tableless.com.br/oocss-smacss-bem-dry-css-afinal-como-escrever-css/). Olhe o código fonte de _frameworks_ para entender a arquitetura usada.
...
[Publicado originalmente no Tableless.](http://tableless.com.br/afinal-como-usar-heranca-no-css/)
